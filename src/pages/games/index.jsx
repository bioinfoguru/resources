    ...
    <div class="min-h-screen bg-gradient-to-br from-purple-900 via-pink-900 to-rose-900">
      ...
      <main class="container mx-auto px-4 py-16">
        <section class="text-center mb-16">
          <h1 class="text-4xl md:text-5xl font-bold text-white mb-6 fade-in">Educational Games</h1>
          <p class="text-xl text-red-200 max-w-3xl mx-auto fade-in-delay">
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="bg-black/30 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-orange-400 transition-all duration-300 glow">
            ...
            <h3 class="text-2xl font-bold text-white mb-3">Immune system defense games</h3>
            <p class="text-orange-100 mb-4">Save the body from pathogens using immune cells.</p>
            <a href="/games/ImmuneSystemDefense" class="text-orange-300 hover:text-white font-medium">Play Now →</a>
          </div>
          {/* Game Card 3 */}
          <div class="bg-black/30 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-orange-400 transition-all duration-300 glow">
            <div class="w-16 h-16 bg-gradient-to-br from-orange-400 via-amber-400 to-yellow-400 rounded-xl flex items-center justify-center mb-6">
            ...
            <h3 class="text-2xl font-bold text-white mb-3">Biology Hangman</h3>
            <p class="text-orange-100 mb-4">Guess the word to prevent getting hanged!</p>
            <a href="/games/BiologyHangman" class="text-orange-300 hover:text-white font-medium">Play Now →</a>
          </div>
          {/* Game Card 4 */}
          <div class="bg-black/30 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-orange-400 transition-all duration-300 glow">
            <div class="w-16 h-16 bg-gradient-to-br from-orange-400 via-amber-400 to-yellow-400 rounded-xl flex items-center justify-center mb-6">
